...
expt_name = "__vanilla_1_conviction"
models = ["gpt-4"]       
TEMPERATURE = 1
   
def main():

   classification_dir = './data/envs_updated/vanilla/binary/'  
   reasoning_dir      = './data/envs_updated/vanilla/reason/'  
   ...
   classification_solutions = {'exp':  ['setup b', 'no' , 'no' , 'no' , 'no' ], 
                                ...
                                'obf':  ['yes', 'yes', 'yes', 'yes', 'yes']}
   
   #for transparent variations
